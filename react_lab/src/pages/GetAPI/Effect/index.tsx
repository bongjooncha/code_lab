        ...
        <div className={styles.textContainer}>
          ...
          <div>
            ...
            <strong style={{ color: "darkred" }}>
              ...
              변경될때 마다 useEffect가 실행된다는 것이다.
              <br />
              <br />
              의존하고 있는 값이 랜더링 될때 마다 리셋이 되고 이로 인해
              useEffect가 실행되며 참고하는 배열이 다시 변하게 되면 이는 무한
              랜더링을 발생시키게 된다.
              <br />
              <br />
              따라서 useMemo를 통해서 의존하고 있는 값을 안정적으로 참고하게
              한다면 안정적으로 useEffect를 운영할 수 있다.
            </strong>
          </div>
        </div>
      </div>
