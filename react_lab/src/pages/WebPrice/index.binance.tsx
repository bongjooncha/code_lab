  ...
  return (
    <div className={style.mainContainer}>
      <div className={style.contentsContainer}>
        <h2 style={{ marginTop: "0" }}>바이낸스 웹소켓</h2>
...
export default BiWebSocketPrice;
